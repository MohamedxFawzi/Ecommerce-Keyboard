 ...
 */
export type PurchaseButtonProps = SliceComponentProps<Content.PurchaseBtnSlice>;

/**
 * Component for "PurchaseButton" Slices.
 */
const PurchaseBtn: FC<PurchaseButtonProps> = ({ slice }) => {
  ...
  return (
    ...
    >
      ...
      >
        <p
          id="buy-button"
          className="mb-6 text-xl font-medium text-gray-700 md:text-2xl"
        >
