...
const ColorChanger: FC<ColorChangerProps> = ({ slice }) => {
  ...
  function handleTextureSelect(texture: (typeof KEYCAP_TEXTURES)[number]) {
    ...
    // set background text to repeated texture name
  }
  ...
  return (
    <section
      ...
      className="relative mt-12 flex h-[90vh] min-h-250 flex-col overflow-hidden bg-linear-to-br from-[#0f172a] to-[#062f4a] text-white"
      id="keycap-changer"
    >
      {/* Svg background */}
      <svg
